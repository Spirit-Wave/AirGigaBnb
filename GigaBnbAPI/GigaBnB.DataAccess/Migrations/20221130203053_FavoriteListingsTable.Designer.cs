...
namespace GigaBnB.DataAccess.Migrations
{
    ...
    [Migration("20221130203053_FavoriteListingsTable")]
    partial class FavoriteListingsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GigaBnB.Model.Models.FavoriteListings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GigaBnB.Model.Models.FavoriteListings", b =>
                {
                    b.HasOne("GigaBnB.Model.Models.Listing", "Listing")
                        .WithMany()
                        .HasForeignKey("ListingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GigaBnB.Model.Models.User", "User")
                        .WithMany()
